...
export function HomeIc({className}){
  return(<>
...
export function Reels({className}){
  return(<>
  <MovieIcon className={className} />
  </>)
}
export function ReelsOut({className}){
  return(<>
  <MovieOutlinedIcon className={className} />
  </>)
}
...
export function EyeIcon({className}){
  return(
    <>
    <RemoveRedEyeIcon className={className}/>
    </>
  )
}


export function EyeCloseIcon({className}){
  return(
    <>
    <VisibilityOffIcon className={className}/>
    </>
  )
}


export function AddBoxIc({className}){
  return(
    <>
    <AddBoxIcon className={className}/>
    </>
  )
}


export function AddBoxOutIc({className}){
  return(
    <>
    <AddBoxOutlinedIcon className={className}/>
    </>
...
export function MessageIc({className}){
  return(
    <>
    <MapsUgcIcon className={className}/>
    </>
  )
}
export function MessageOutIc({className}){
  return(
    <>
    <MapsUgcOutlinedIcon className={className}/>
    </>
  )
}